...
//     it.skip("should add the proposal to the batch from new provider", async () => {
...
//     });
//     it.skip("should not add the proposal to the batch from the existing provider and the same hardware configuration", async () => {
...
//     });
//
//     it.skip("should add the proposal to the batch from the existing provider and different hardware configuration", async () => {
...
//     it.skip("should read the set of proposals grouped by provider key distinguished by provider id, cpu, threads, memory and storage", async () => {
//       const proposalsBatch = new ProposalsBatch({ releaseTimeoutMs: 100 });
//       const mockedProposal1 = mock(Proposal);
//       when(mockedProposal1.provider).thenReturn(mockedProviderInfo);
//       when(mockedProposal1.properties).thenReturn({
...
//     });
//     it.skip("should read the set of proposal grouped by provider key and reduced proposals from teh same provider to the lowest price and highest time", async () => {
//       const proposalsBatch = new ProposalsBatch({ releaseTimeoutMs: 100 });
//       const mockedProposal1 = mock(Proposal);
//       when(mockedProposal1.provider).thenReturn(mockedProviderInfo);
//       when(mockedProposal1.properties).thenReturn({
...
//     });
//     it.skip("should drain batch after reading proposals", async () => {
//       const proposalsBatch = new ProposalsBatch({ releaseTimeoutMs: 100 });
//       const mockedProposal = mock(Proposal);
//       when(mockedProposal.provider).thenReturn(mockedProviderInfo);
//       when(mockedProposal.properties).thenReturn({
...
//       await proposalsBatch.addProposal(proposal);
//       expect((await proposalsBatch.getProposals()).length).toEqual(1);
//       expect((await proposalsBatch.getProposals()).lengt h).toEqual(0);
//     });
//   });
// });
