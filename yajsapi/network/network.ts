...
export class NetworkNode {
  constructor() // public readonly node_id: string,
...
export class Network {
   ...
   */
  constructor() // net_api: RequestorApi,
  // ip: string,
  // owner_id: string,
  // owner_ip?: string,
  // mask?: string,
  ...
  //   await this._net_api.addNode(this.network_id!, node_id, ip.toString());
  //   return node;
  // }
  //
  // /**
   ...
   * @param gateway   optional gateway address for the network
   */
  static async create(): // net_api: Net,
  // ip: string,
  // owner_id: string,
  // logger?: Logger,
  // owner_ip?: string,
