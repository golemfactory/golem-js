...
export declare class ResourceRental {
    ...
    private finalizeAbortController;
     ...
     */
    destroyExeUnit(signalOrTimeout?: AbortSignal | number): Promise<void>;
    fetchAgreementState(signalOrTimeout?: number | AbortSignal): Promise<"Proposal" | "Pending" | "Cancelled" | "Rejected" | "Approved" | "Expired" | "Terminated">;
