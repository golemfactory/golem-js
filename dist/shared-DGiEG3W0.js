...
function getPaymentNetwork() {
    var _a;
    return isNode ? ((_a = process.env.PAYMENT_NETWORK) !== null && _a !== void 0 ? _a : "hoodi") : "hoodi";
}
function isDevMode() {
...
class DemandBodyBuilder {
    ...
    addConstraint(key, value, comparisonOperator = exports.ComparisonOperator.Eq) {
    ...
    parseConstraint(constraint) {
        for (const key in exports.ComparisonOperator) {
            const value = exports.ComparisonOperator[key];
...
class WorkloadDemandDirectorConfig extends BaseConfig {
    constructor(options) {
        ...
        this.customConstraints = (_a = options.customConstraints) !== null && _a !== void 0 ? _a : [];
        if (!((_b = options.runtime) === null || _b === void 0 ? void 0 : _b.name)) {
...
class WorkloadDemandDirector {
    ...
    async apply(builder) {
        ...
        builder
            .addConstraint("golem.inf.mem.gib", this.config.minMemGib, exports.ComparisonOperator.GtEq)
            .addConstraint("golem.inf.storage.gib", this.config.minStorageGib, exports.ComparisonOperator.GtEq)
            .addConstraint("golem.inf.cpu.cores", this.config.minCpuCores, exports.ComparisonOperator.GtEq)
            .addConstraint("golem.inf.cpu.threads", this.config.minCpuThreads, exports.ComparisonOperator.GtEq);
...
class ScanDirector {
    ...
    addWorkloadDecorations(builder) {
        ...
        if ((_l = this.options.workload) === null || _l === void 0 ? void 0 : _l.minMemGib) {
            builder.addConstraint("golem.inf.mem.gib", (_m = this.options.workload) === null || _m === void 0 ? void 0 : _m.minMemGib, exports.ComparisonOperator.GtEq);
        }
        if ((_o = this.options.workload) === null || _o === void 0 ? void 0 : _o.maxMemGib) {
            builder.addConstraint("golem.inf.mem.gib", (_p = this.options.workload) === null || _p === void 0 ? void 0 : _p.maxMemGib, exports.ComparisonOperator.LtEq);
        }
        if ((_q = this.options.workload) === null || _q === void 0 ? void 0 : _q.minStorageGib) {
            builder.addConstraint("golem.inf.storage.gib", (_r = this.options.workload) === null || _r === void 0 ? void 0 : _r.minStorageGib, exports.ComparisonOperator.GtEq);
        }
        if ((_s = this.options.workload) === null || _s === void 0 ? void 0 : _s.maxStorageGib) {
            builder.addConstraint("golem.inf.storage.gib", (_t = this.options.workload) === null || _t === void 0 ? void 0 : _t.maxStorageGib, exports.ComparisonOperator.LtEq);
        }
        if ((_u = this.options.workload) === null || _u === void 0 ? void 0 : _u.minCpuThreads) {
            builder.addConstraint("golem.inf.cpu.threads", (_v = this.options.workload) === null || _v === void 0 ? void 0 : _v.minCpuThreads, exports.ComparisonOperator.GtEq);
        }
        if ((_w = this.options.workload) === null || _w === void 0 ? void 0 : _w.maxCpuThreads) {
            builder.addConstraint("golem.inf.cpu.threads", (_x = this.options.workload) === null || _x === void 0 ? void 0 : _x.maxCpuThreads, exports.ComparisonOperator.LtEq);
        }
        if ((_y = this.options.workload) === null || _y === void 0 ? void 0 : _y.minCpuCores) {
            builder.addConstraint("golem.inf.cpu.cores", (_z = this.options.workload) === null || _z === void 0 ? void 0 : _z.minCpuCores, exports.ComparisonOperator.GtEq);
        }
        if ((_0 = this.options.workload) === null || _0 === void 0 ? void 0 : _0.maxCpuCores) {
            builder.addConstraint("golem.inf.cpu.cores", (_1 = this.options.workload) === null || _1 === void 0 ? void 0 : _1.maxCpuCores, exports.ComparisonOperator.LtEq);
        }
    }
...
class ExeUnit {
    ...
    async deployActivity(setupAbortSignal) {
        var _a, _b;
        try {
...
class ActivityModuleImpl {
    ...
    async createExeUnit(activity, options) {
        ...
        try {
            await exe.setup(options === null || options === void 0 ? void 0 : options.setupSignalOrTimeout);
...
//# sourceMappingURL=shared-DGiEG3W0.js.map
