    ...
    async setup() {
        try {
            ...
            if (state !== ActivityStateEnum.Ready) {
                ...
                throw new GolemWorkError(`Activity ${this.activity.id} cannot reach the Ready state at: ${currentDateTime}. Current state: ${state}`, WorkErrorCode.ActivityDeploymentFailed, this.activity.agreement, this.activity, this.activity.provider);
            }
            await this.setupActivity();
        }
        catch (error) {
...
//# sourceMappingURL=shared-BES5zO0i.mjs.map
